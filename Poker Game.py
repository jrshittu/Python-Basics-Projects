...
names = {nine: "9", ten:"10", jack:"J", queen:"4", king:"K", ace:"A"}

player_score = 0
computer_score = 0

def start():
    print("Let's play the Poker Game")
    while game():
        pass
    score()

def game():
    print("Robot will help you throw your dice")
    throws()
    return reset()
    ...
    while iterations < rerolls:
        ...
        while True:
            ...
            try:
                ...
                print("I didn't understand that. please enter 1, 2, 3, 4, or 5")
